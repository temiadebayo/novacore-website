  ...
  return (
    <footer id="contact" ref={ref} className="bg-gray-900 text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <button className="group inline-flex items-center gap-2 px-6 py-3 bg-primary-500 hover:bg-primary-600 rounded-lg font-semibold transition-all duration-300 hover:scale-105">
            <Mail className="w-5 h-5" />
            Contact Us
          </button>
          <button className="group inline-flex items-center gap-2 px-6 py-3 bg-brand-950 hover:bg-brand-900 rounded-lg font-semibold transition-all duration-300 hover:scale-105">
            <Calendar className="w-5 h-5" />
            Schedule a Demo
          </button>
          <button className="group inline-flex items-center gap-2 px-6 py-3 bg-gray-800 hover:bg-gray-700 rounded-lg font-semibold transition-all duration-300 hover:scale-105">
